...
public class GuessingTree {
     ...
     * This method recursively visits each node in the tree and prints the 
     * values of the member variables to the console.
     * @param node 
     */
     ...
     * Recursively visits each node, depth-first, and writes node attributes
     ...
     * Recursively adds nodes per the user's specifications
     * @param option
     * @param splitStack 
     */
     ...
     * Runs through the tree, displaying confirm dialog for the user
     * to input their responses. At the end of the tree, the user
     * adds additional nodes if they have won the game.
     * @param node 
     */
